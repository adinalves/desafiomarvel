...
const Home = () => {
    class App {
        ...
        constructor() {
          ...
          this.addEvents();
          this.Logout();
          //document.getElementById('nick').innerHTML = this.decodejwt();
        ...
        searchComics() {
          ...
          decodejwt(){
            const teste = localStorage.getItem('app-token');
            //const teste = sessionStorage["app-token"];
           console.log(teste);
            let token = teste;
            //var token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImZseV9ib3kiLCJmaXJzdE5hbWUiOiJhZGluZSIsImlhdCI6MTYyNzI1MDA4OX0.89kiSeyQdMeeWBehjH50h5mR-1tLY1fZ96mYWL6xoOg";
